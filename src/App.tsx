...
const Stores = () => <div className="p-6 mt-10"><h1 className="text-2xl font-bold">Gestión de Tiendas</h1><p className="text-gray-600 mt-2">Módulo de administración de tiendas</p></div>;
