// Tipos para Sistema de Auditorías
...
// Nuevas interfaces para sistema modular de preguntas
export interface PreguntaVariable {
  id_pregunta_variable: number;
  id_auditoria: number;
...
export interface PreguntaEliminada {
  id_pregunta_eliminada: number;
  id_auditoria: number;
  id_pregunta: number;
...
// Tipos para la gestión de preguntas modulares
export interface NuevaPreguntaVariable {
  id_auditoria: number;
  id_subcategoria: number;
  texto_pregunta: string;
  orden: number;
...
export interface EliminarPregunta {
  id_auditoria: number;
  id_pregunta: number;
  eliminado_por?: string;
  motivo?: string;
...
// Tipo para pregunta consolidada (base + variable)
export interface PreguntaConsolidada {
  id: number; // id_pregunta para base, id_pregunta_variable para variables
  tipo: 'base' | 'variable';
  subcategoria_id: number;
  texto_pregunta: string;
  orden: number;
